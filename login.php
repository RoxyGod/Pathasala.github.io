...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link rel="stylesheet" text="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
...
<body>
    ...
    <style>
    body {
        background-image: url("image/aj.jpg");
    ...
    <body>
        ...
        <form action="logged in.php" method="post" class="logIn" autocomplete="off" >
            <div class="myform">login your Account</div>

            <label class="id" name="emailAd"> Email Address:</label>
            <div class="form">
                <input class="inputField" type="email" name="mail" placeholder="abc@email.com" required>
            </div>
    
            <label class="id" name="Pass"> Password:</label>
            <div class="form">
            ...
            <div>
                <button  id="loginBtn" type="submit" name="login" class="loginBtn" >login</button>
            </div>
