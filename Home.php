...
<body>
  ...
  <div>
    <img src="image/library.jpg" class="img-fluid" alt="...">
    <div class="ptext">
      <span class="border trans">
        <h3 id="lib"><b><mark>Welcome to Khulla Pathsala</mark></b></h3><br>
         <div id="lib">
       <p id="lib"> <mark>We assure Your Best Learning With Us.</mark></p>
         </div>
       <a href="login.php"><button class="btn">Start Your Journey</button></a>
      </span>
    </div>
  </div>
